...
ggsave("coxme_stats_ex.png", width = 7, height = 5)
```
...
# All statuses and exceptions and random effects for center and exception
``` {r coxme_stat_ex_long_exrand2}
# coxme_stat_ex_long_exrand2 <- coxme(Surv(t_start, t_stop, death) ~ can_stat_active + rec_exception + (1 + rec_exception | CAN_LISTING_CTR_ID), data = full_list_cox)
# 
# summary(coxme_stat_ex_long_exrand2)
# 
# plot_model(
#   coxme_stat_ex_long_exrand2,
#   show.values = TRUE,
#   value.offset = .3,
#   axis.labels = c(
#     "Exception",
...
# )
# 
# ggsave("coxme_stat_ex_long_exrand2.png", width = 7, height = 5)
# 
# # ranef(coxme_stat_ex_long_exrand2)
```

# All statuses and exceptions and random effects for center and exception without random intercepts
``` {r coxme_stat_ex_long_exrand3}
# coxme_stat_ex_long_exrand3 <- coxme(Surv(t_start, t_stop, death) ~ can_stat_active + rec_exception + (rec_exception | CAN_LISTING_CTR_ID), data = full_list_cox)
# 
# summary(coxme_stat_ex_long_exrand3)
# 
# plot_model(
#   coxme_stat_ex_long_exrand3,
#   show.values = TRUE,
#   value.offset = .3,
#   axis.labels = c(
#     "Exception",
...
# )
# 
# ggsave("coxme_stat_ex_long_exrand3.png", width = 7, height = 5)
```
...
# Save RData
``` {r save}
# save(full_list_cox, coxme_stat_ex_long_exrand, coxme_stat_ex_long_exrand2, coxme_stat_ex_long_exrand3, full_list_cox, file = "cox_models_over10.RData")
```