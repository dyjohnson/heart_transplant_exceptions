...
ggsave("km_curve_all.png", width = 7, height = 5)
...
ggsave("km_curve_1.png", width = 7, height = 5)
...
ggsave("km_curve_2.png", width = 7, height = 5)
...
ggsave("km_curve_3.png", width = 7, height = 5)
...
ggsave("km_curve_4.png", width = 7, height = 5)
...
ggsave("coxme_stat_ex_post.png", width = 7, height = 5)
```
